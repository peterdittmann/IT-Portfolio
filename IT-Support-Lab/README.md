...
Simulated a Windows IT support environment within a virtual machine to perform common help desk tasks including user account management, password resets, permission troubleshooting, shared resource access, printer service recovery, and system performance optimization. Demonstrated a structured troubleshooting methodology to diagnose issues, apply targeted fixes, and verify successful resolution.
